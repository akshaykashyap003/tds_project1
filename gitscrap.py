...
def main():
    ...
    # Search for users in Mumbai with >100 followers
    users = scraper.search_users(location='Mumbai', min_followers=50)
    ...
    with open('README.md', 'w') as f:
        f.write(f"""# GitHub Users in Mumbai
...
1. `users.csv`: Contains information about {len(users)} GitHub users in Mumbai with over 100 followers
